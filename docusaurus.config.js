...
const config = {
  title: "Triple CMS Documentation",
  tagline: "Alpha Version - Work in Progress - 07 May 2025",
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: "Triple CMS",
        logo: {
          alt: "Triple Builder Logo",
          src: "img/builder_logo.png",
        },
        items: [
          {
            type: "docSidebar",
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Triple, llc. Built with Docusaurus.`,
      },
      prism: {
